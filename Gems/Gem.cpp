...
constexpr unsigned BONUS_RADIUS = 4;
constexpr float BONUS_PROB = 0.1f;

static std::map<Gem::Color, sf::Color> gcolorMap = 
{
    { Gem::Color::Green, sf::Color(28,236,62)},
    { Gem::Color::Red, sf::Color(255, 10, 10)},
    { Gem::Color::Yellow, sf::Color(255, 255, 150, 255)},
    { Gem::Color::Violet, sf::Color(148, 0, 211)},
    { Gem::Color::Blue, sf::Color(10, 10, 255)}
};
